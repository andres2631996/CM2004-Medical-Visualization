# -*- coding: utf-8 -*-
"""
Created on Wed Nov 20 14:24:47 2019
...
class TimerCallback:
    ...
    def __call__(self,obj,event):
        angle = (self.timer_count % int(1/self.speed))*2*pi*self.speed
        self.plane.SetNormal(sin(angle),cos(angle),0)
...
if __name__ == '__main__':
    ...
    global plane
    plane = vtk.vtkPlane()
    plane.SetOrigin(128.0, 128.0, 128.0)
    # 2 set up the source
